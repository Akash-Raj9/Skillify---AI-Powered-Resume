...
const handleGetStarted = () => {
  ...
  return (
    <>
      <div
        id="cta"
        className="max-w-6xl mx-2 md:mx-auto p-px my-16 rounded-2xl bg-gradient-to-r from-purple-600/20 to-blue-500/30"
      >
        <div className="flex flex-col items-center justify-center text-center py-12 md:py-16 rounded-[15px] bg-gradient-to-r from-[#F3EAFF] to-[#E1EFFF]">
          ...
          <h2 className="text-2xl md:text-4xl font-medium mt-3">
            Unlock Your Potential with <br />
            <span className="bg-gradient-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent">
              Smart AI-Based Resume
            </span>{' '}
            & Proven Results !
          </h2>

          <p className="text-slate-500 mt-3 max-w-lg max-md:text-sm">
            Accelerate your career growth with tailored resume building, actionable insights, and continuous support that empowers you to succeed confidently in today’s competitive job market.
          </p>
          ...
          <button
            ...
            type="button"
            className="bg-gradient-to-r from-purple-600 to-blue-500 text-white text-sm px-5 py-2.5 rounded-xl font-medium mt-5 hover:scale-105 active:scale-95 transition-all duration-300"
          >
            Get Started Today
          </button>
        </div>
